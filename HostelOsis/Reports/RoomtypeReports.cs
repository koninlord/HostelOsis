...
namespace HostelOsis.Reports
{
    public class RoomtypeReports
    {
        private RoomTypeService _roomTypeService;

        public RoomtypeReports(RoomTypeService roomTypeService)
        {
            _roomTypeService = roomTypeService;
        }

        public RoomtypeReports(RoomtypeReports roomtypeReports)
        {
            this.roomtypeReports = roomtypeReports;
        }
        ...
        private RoomtypeReports roomtypeReports;
